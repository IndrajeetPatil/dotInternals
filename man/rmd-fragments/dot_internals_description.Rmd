...
You need to run this function in the **package root directory**. There is also RStudio addin that you can use. 

**Note**: This will not work if you have already run `devtools::load_all()`/`pkgload::load_all()`.
